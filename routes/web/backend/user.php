...
Route::get('/user/store', [UserController::class, 'store'])->name('be.user.store');
...
Route::delete('/user/mass/destroy', [UserController::class, 'massDestroy'])->name('be.user.mass.destroy');