                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-header">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create_users', $users)): ?>
                            <div class="row mb-4">
                                <div class="col-6"></div>
                        ...
                        <div class="card-body">
                                ...
                                <table class="table table-lg">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-bold-500"><?php echo e($user->username); ?></td>
                                            <td class="text-bold-500"><?php echo e($user->email); ?></td>
                                            <td>
                                                <div style="display: flex; gap: 5px;">
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit_users', $user)): ?>
                                                    <a href="<?php echo e(route('user.edit', $user->id)); ?>" class="btn btn-sm btn-outline-warning">Edit</a>
                                                    <?php endif; ?>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('destroy_users', $user)): ?>
                            ...
                            <div class="row">
                                <div class="col-12 d-flex justify-content-end">
                                    <?php echo e($users->appends(['limit' => $perPage, 'q' => $q])->links()); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('template.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lanas\Documents\Codelabs\Laravel\personal-blog-laravel-10\resources\views/backend/user/index.blade.php ENDPATH**/ ?>