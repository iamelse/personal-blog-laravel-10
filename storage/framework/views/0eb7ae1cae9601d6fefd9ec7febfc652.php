            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="POST" action="<?php echo e(route('experience.store')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
...
unset($__errorArgs, $__bag); ?>" id="company_logo_size" placeholder="Company Logo Size" name="company_logo_size" value="<?php echo e(old('company_logo_size')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="company_name" placeholder="Company Name" name="company_name" value="<?php echo e(old('company_name')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="position_name" placeholder="Position Name" name="position_name" value="<?php echo e(old('position_name')); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('template.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lanas\Documents\Codelabs\Laravel\personal-blog-laravel-10\resources\views\backend\resume\experience\create.blade.php ENDPATH**/ ?>