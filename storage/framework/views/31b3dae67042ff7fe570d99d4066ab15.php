...
unset($__errorArgs, $__bag); ?>" placeholder="Category Name" name="category_name" id="name" value="<?php echo e(old('category_name', $postCategory->name)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" placeholder="Slug" name="slug" id="slug" value="<?php echo e(old('slug', $postCategory->slug)); ?>" readonly/>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row">
                                    <div class="col-12 d-flex justify-content-end">
                                        ...
                                        <a href="<?php echo e(route('post.category.index')); ?>" class="btn btn-sm btn-light-secondary me-1 mb-1">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('template.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lanas\Documents\Codelabs\Laravel\personal-blog-laravel-10\resources\views\backend\post_category\edit.blade.php ENDPATH**/ ?>