        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>New Education</h3>
                    <p class="text-subtitle text-muted">Create a new educational background details.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="POST" action="<?php echo e(route('education.store')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row">
...
unset($__errorArgs, $__bag); ?>" id="school_logo_size" placeholder="Logo Size" name="school_logo_size" value="<?php echo e(old('school_logo_size')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="school_name" placeholder="School Name" name="school_name" value="<?php echo e(old('school_name')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="major" placeholder="Major" name="major" value="<?php echo e(old('major')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="degree" placeholder="Degree" name="degree" value="<?php echo e(old('degree')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="desc" placeholder="Description" name="desc" rows="4"><?php echo e(old('desc')); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('template.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lanas\Documents\Codelabs\Laravel\personal-blog-laravel-10\resources\views\backend\resume\education\create.blade.php ENDPATH**/ ?>