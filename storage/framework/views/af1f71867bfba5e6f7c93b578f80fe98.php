        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>New Language Skill</h3>
                    <p class="text-subtitle text-muted">Create a new language skills information.</p>
                </div>
            </div>
        </div>        
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="POST" action="<?php echo e(route('skill.language.store')); ?>">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-12">
...
unset($__errorArgs, $__bag); ?>" placeholder="Language Skill Name" name="language_skill_name" value="<?php echo e(old('language_skill_name')); ?>" />
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('template.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lanas\Documents\Codelabs\Laravel\personal-blog-laravel-10\resources\views\backend\resume\skills\language\create.blade.php ENDPATH**/ ?>