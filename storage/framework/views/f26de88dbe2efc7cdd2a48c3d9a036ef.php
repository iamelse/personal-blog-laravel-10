            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form method="POST" action="<?php echo e(route('backend.project.update', $project->id)); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="Project Title" name="title" id="title" value="<?php echo e(old('title', $project->title)); ?>"/>
...
unset($__errorArgs, $__bag); ?>" placeholder="Slug" name="slug" id="slug" value="<?php echo e(old('slug', $project->slug)); ?>" readonly/>
...
unset($__errorArgs, $__bag); ?>" name="content" rows="10" cols="50"><?php echo e(old('content', $project->desc)); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('template.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lanas\Documents\Codelabs\Laravel\personal-blog-laravel-10\resources\views\backend\project\edit.blade.php ENDPATH**/ ?>