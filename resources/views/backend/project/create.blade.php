            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form method="POST" action="{{ route('backend.project.store') }}" enctype="multipart/form-data">
                                @csrf

                                <div class="form-group mandatory mb-3">
                                    <label class="form-label">Title</label>
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Project Title" name="title" id="title" value="{{ old('title') }}"/>
                                    @error('title')
                                ...
                                <div class="row">
                                    <div class="col-12 d-flex justify-content-end">
                                        ...
                                        <a href="{{ route('backend.project.index') }}" class="btn btn-light-secondary me-1 mb-1">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
