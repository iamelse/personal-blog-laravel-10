                        ...
                        <div class="card-header">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-6 text-end">
                                    <a href="{{ route('skill.language.create') }}" class="btn btn-primary btn-sm">
                                        New Language Skill
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-10 text-start">
                                    <div class="col-1">
                                        <form method="GET" action="{{ route('skill.language.index') }}">
                                ...
                                <div class="col-2">
                                    <form method="GET" action="{{ route('skill.language.search') }}">
                        ...
                        <div class="card-body">
                                ...
                                <table class="table table-lg">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-bold-500">{{ $languageSkill->name }}</td>
                            ...
                            <div class="row">
                                <div class="col-12 d-flex justify-content-end">
                                    {{ $languageSkills->appends(['limit' => $perPage, 'q' => $q])->links() }}
                                </div>
                            </div>                
                        </div>
                    </div>
