      ...
      <div class="mt-10 flex flex-col lg:flex-row items-center gap-10">
        ...
        <article class="w-full lg:w-3/4 text-left">
          <div data-aos="fade-left" class="space-y-3 lg:space-y-4">
            <div>
              <h2 class="text-xl lg:text-3xl font-bold text-gray-900 dark:text-gray-100">Short Bio</h2>
            ...
            <div>
              <h2 class="text-xl lg:text-3xl font-bold text-gray-900 dark:text-gray-100">Career</h2>
              <p class="text-base sm:text-lg text-gray-600 dark:text-gray-300">
            ...
            <div>
              <h2 class="text-xl lg:text-3xl font-bold text-gray-900 dark:text-gray-100">About Me</h2>
              <p class="text-base sm:text-lg text-gray-600 dark:text-gray-300">
